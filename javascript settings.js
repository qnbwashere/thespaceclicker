export class Settings {
  ...
  updateUI() {
    try {
      const elements = {
        'music-volume': this.settings.audio.musicVolume,
        'sfx-volume': this.settings.audio.sfxVolume,
        'audio-enabled': this.settings.audio.enabled,
        'effects': this.settings.graphics.effects,
        'brightness': this.settings.graphics.brightness,
        'auto-save': this.settings.gameplay.autoSave
      };
